...
int main(int argc, char** argv)
{
	...
	//cout << "dataMatrix " << dataMatrix << endl; --> threshold x = 2 and threshold y = 2 is realistic
	...
	//cout << "densityXY " << densityXY[0] << endl;
...
void plotData(Mat dataMatrix, char const * name)
{
	...
	imwrite("DataMatrix.png", origImage);
}
