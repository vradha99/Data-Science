...
def box_filter(img, r):
    ...
    result=box_filter_columns(img,r)
    result=box_filter_rows(result,r)
    return result
...
def box_filter_columns(img, r):
    ...
    #print(integral_image_cols)
    # TODO: replace the right side with the correct implementation
    #print(integral_image_cols,"cumsum ressult")
    ...
    #
    # image boundary (top)
    #print((np.tile(integral_image_cols[rows-1,:],[r,1])-integral_image_cols[rows-2*r:rows-r-1,:]).shape,"res")
    ...
    #print(integral_image_cols[rows-2*r:rows-r-1,:].shape)
    return result
...
def box_filter_rows(img, r):
    ...
    #print((np.tile(integral_image_rows[:,columns-1].T,[r,1]).T).shape)
    #print(integral_image_rows[:, columns-2*r:columns-r].shape)
...
def guided_filter(g, i, r, epsilon):
    ...
    mean_g = mean_filter(i, r, n) # TODO: implement the correct steps here
    # (1b) compute the auto-correlation of the guidance image and cross-correlation with the input image g
    corr_i = box_filter(i*i,r)/n  # TODO: implement the correct steps here
    corr_ig = box_filter(i*g,r)/n  # TODO: implement the correct steps here
    ...
    mean_a = box_filter(a,r)/n   # TODO: implement the correct steps here
    mean_b = box_filter(b,r)/n   # TODO: implement the correct steps here
